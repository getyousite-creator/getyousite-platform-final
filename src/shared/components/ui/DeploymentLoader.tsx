...
import { Shield, Server, Globe, CheckCircle2, Cpu } from "lucide-react";
import { cn } from "@/lib/utils";
import { useLocale } from "next-intl";

const DEPLOYMENT_STEPS = [
    { id: 1, label: { en: "Strategic Logical Synthesis", ar: "التوليف المنطقي العصبي" }, icon: Cpu },
    { id: 2, label: { en: "Industrial Asset Optimization", ar: "تحسين الأصول الصناعية" }, icon: Server },
    { id: 3, label: { en: "Global Edge Provisioning", ar: "توفير النودز العالمية" }, icon: Globe },
    { id: 4, label: { en: "Sovereign Security Audit", ar: "تدقيق الأمن السيادي" }, icon: Shield },
    { id: 5, label: { en: "Transmission Activation", ar: "تفعيل البث المباشر" }, icon: CheckCircle2 }
];
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="space-y-4">
                                {DEPLOYMENT_STEPS.map((step, index) => {
                                    ...
                                    const label = typeof step.label === 'string' ? step.label : (isArabic ? step.label.ar : step.label.en);
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-white/40">
                                    <span>{isArabic ? "حالة بناء النظام السيادي" : "Sovereign Build Status"}</span>
