            ...
            {showText && (
                <div className="flex flex-col -space-y-1.5 pt-0.5">
                    <div className="flex items-center gap-1.5">
                        <span className="text-2xl font-black tracking-[-0.05em] text-white leading-none uppercase">GYS Global</span>
                        <div className="px-1.5 py-0.5 bg-primary/20 border border-primary/30 rounded text-[7px] font-black text-primary uppercase tracking-widest">
                            Enterprise
                        </div>
                    </div>
                    <span className="text-[8px] font-black tracking-[0.5em] text-white/20 uppercase ml-0.5">Sovereign Engineering</span>
                </div>
            )}
        </div>
    );
