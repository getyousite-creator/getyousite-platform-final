...
export default function MasterWellness(props: SovereignTemplateProps) {
    ...
    const heroImg =
        ...
        "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2440&auto=format&fit=crop";
            ...
            {() => (
                <div className="bg-[#fff9f5] text-stone-900 min-h-screen selection:bg-orange-100 selection:text-orange-950 font-sans">
                        ...
                        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            ...
                            >
                                <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white border border-orange-50 shadow-sm">
                                    ...
                                    <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest font-sans">
                                        {t("serenity_protocol")}
                                    </span>
                                </div>
                    ...
                    <section className="py-32 bg-white">
                        <div className="container mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
                            {[
                                ...
                                {
                                    icon: Award,
                                    title: t("certified_care"),
                                    label: t("elite_standard"),
                                },
                            ].map((stat, i) => (
                        ...
                        <div className="container mx-auto px-6">
                            <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
                                <div>
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-orange-500 mt-6 font-sans">
                                        {t("biological_assets")}
                                    </p>
                                </div>
                            </div>
                                ...
                                {treatments.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="px-4">
                                            ...
                                            <p className="text-stone-400 font-medium leading-relaxed font-sans text-sm">
                                                {item.desc}
                                            </p>
                                        </div>
                                    </motion.div>
                    ...
                    <section className="py-40 bg-white">
                        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            ...
                            <div className="space-y-12">
                                ...
                                <h3 className="text-4xl font-black uppercase leading-none italic italic">
                                    &quot;{t("testimonial_quote")}&quot;
                                </h3>
                    ...
                    <footer className="py-24 border-t border-orange-50 flex flex-col items-center gap-10 font-sans">
                        ...
                        <p className="text-[9px] text-stone-200 font-bold uppercase tracking-[1em] mt-12 text-center px-4">
                            {t("infrastructure")}
                        </p>
                    </footer>
                </div>
