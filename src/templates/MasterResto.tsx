                ...
                <div className="bg-[#fafaf9] text-stone-900 min-h-screen selection:bg-orange-100 selection:text-orange-900 font-serif">
                    ...
                    <section className="py-32 px-6 lg:px-12 max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-5 space-y-8">
                            ...
                            <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter leading-none italic">Engineering <br /> The Perfect Bite.</h2>
                            ...
                            <div className="flex flex-col gap-6 pt-10">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4 items-start border-l-2 border-stone-100 pl-6">
                                        ...
                                        <div>
                                            <h4 className="text-xs font-black uppercase tracking-widest mb-1 font-sans">{item.title}</h4>
                                            <p className="text-[11px] text-stone-400 font-bold uppercase font-sans tracking-wide">{item.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="container mx-auto px-6">
                            <div className="flex flex-col md:flex-row items-baseline justify-between mb-24 gap-4">
                                ...
                                <div className="flex gap-6 text-[10px] font-black uppercase tracking-widest text-stone-600 font-sans">
                                    ...
                                    <span className="hover:text-white cursor-pointer transition-colors pb-2">Main_Assets</span>
                                    <span className="hover:text-white cursor-pointer transition-colors pb-2">Elixirs</span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20">
                                {menuItems.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-2xl font-black uppercase tracking-tight italic border-b border-white/5 pb-4 mb-4">{item.name}</h3>
                                        <p className="text-stone-500 font-medium leading-relaxed font-sans uppercase text-[10px] tracking-widest">{item.description}</p>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
                    ...
                    <section className="py-40 bg-white">
                        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20">
                            <div className="space-y-12">
                                <h2 className="text-5xl font-black uppercase tracking-tighter italic">Foundations.</h2>
                                <div className="space-y-10">
                                    ...
                                    <div className="flex gap-6 items-center">
                                        ...
                                        <div className="font-sans">
                                            <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1">Service Hours</p>
                                            <p className="text-lg font-bold">MON - SUN: 12:00 - 01:00</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 items-center">
                                        <Phone className="w-8 h-8 text-stone-300" />
                                        <div className="font-sans">
                                            <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1">Direct Line</p>
                            ...
                            >
                                ...
                                <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tightest italic leading-none">Initiate <br /> The_Table.</h3>
