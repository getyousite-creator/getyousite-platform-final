...
export default function MasterPublic(props: SovereignTemplateProps) {
    ...
    const articles: Article[] = articlesRaw.length > 0 ? articlesRaw.map((item) => ({
        ...
        { title: t("Strategic_synthesis"), excerpt: t("Strategic_synthesis_desc"), author: t("def_author"), date: "JAN 2026", img: "https://images.unsplash.com/photo-1542831371-29b0f74f9713?q=80&w=2070&auto=format&fit=crop", category: t("cat_technology") },
