...
export default function AlphaStore({ settings, blueprint }: SovereignTemplateProps) {
    ...
    const productsSection = blueprint?.layout?.find(
        (s) => s.type === "features" || s.type === "custom",
    );
    const products = (productsSection?.content?.products as Product[]) || [
        {
            name: "Quantum Fabric 01",
            price: "$240",
        ...
        },
        {
            name: "Astra Lens",
            price: "$1,200",
            img: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=2430",
        },
        {
            name: "Sovereign Core",
            price: "$89",
            img: "https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2430",
        },
    ];
            ...
            {({ settings, onOpen }) => (
                ...
                >
                        ...
                        <div className="hidden lg:flex items-center gap-16 text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">
                            ...
                            <div className="flex items-center gap-8 pl-10 border-l border-zinc-100">
                                ...
                                >
                                    ...
                                    <div className="absolute -top-2 -right-2 w-4 h-4 bg-zinc-950 text-white rounded-full flex items-center justify-center text-[7px] font-black">
                                        2
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="px-10 py-24 grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-[1920px] mx-auto">
                        <div
                            className="lg:col-span-8 relative aspect-[21/9] rounded-[40px] bg-zinc-100 overflow-hidden group cursor-pointer"
                            onClick={() => onOpen("Season Drop")}
                        >
                            <SovereignImage
                                src={heroImage}
                                alt="Pro Showcase"
                        ...
                        <div className="lg:col-span-4 bg-zinc-950 rounded-[40px] p-12 text-white flex flex-col justify-between">
                            <div>
                                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-500 mb-8 block">
                                    Exclusive_Access
                                </span>
                    ...
                    <section className="px-10 py-32 bg-zinc-50 rounded-t-[100px]">
                        <div className="flex items-end justify-between mb-24">
                            <div>
                                <h2 className="text-5xl font-black tracking-tightest uppercase italic font-serif">
                                    Curated Assets.
                                </h2>
                                <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.5em] mt-4">
                                    Transcribed from Sovereign Archives
                                </p>
                            </div>
