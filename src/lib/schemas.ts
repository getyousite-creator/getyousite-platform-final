...
export const PageSchema = z.object({
    ...
    keywords: z.array(z.string()).optional(), // Image search keywords generated by Strategic Synthesis
});
...
export const SiteBlueprintSchema = z.object({
    ...
    architecture_insight: z.string().optional().describe("Strategic reasoning behind the design choices"),
