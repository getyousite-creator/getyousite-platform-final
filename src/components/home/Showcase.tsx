...
export default function Showcase() {
    ...
    return (
        <section id="showcase" className="py-32 bg-slate-950 relative overflow-hidden">
            {/* Background Orbs - Deep Spectrum */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-600/5 rounded-full blur-[140px] -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-slate-800/10 rounded-full blur-[140px] translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
                    ...
                    <Button
                        variant="glow"
                        className="h-16 px-10 bg-blue-600 hover:bg-blue-500 border-none text-white font-black tracking-widest uppercase text-xs shadow-[0_0_30px_rgba(37,99,235,0.3)] group"
