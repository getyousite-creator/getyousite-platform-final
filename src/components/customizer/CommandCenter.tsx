...
const AVAILABLE_TEMPLATES: CommandTemplate[] = (SHARED_TEMPLATES as SharedTemplate[]).map((t) => ({
    id: t.id,
    name: t.title,
    slug: t.id,
    description: t.desc,
...
export function CommandCenter(props: CommandCenterProps) {
    ...
    const filteredTemplates = AVAILABLE_TEMPLATES.filter(
        (t) =>
                ...
                <TabsContent value="pages" className="space-y-6 mt-6">
                    <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/10 mb-4">
                        <p className="text-[10px] text-blue-400 font-bold uppercase tracking-widest leading-relaxed">
                            SOVEREIGN_GEN_PROTOCOL: Generating sub-pages separately ensures logic
                            perfection and zero-cost efficiency.
                        </p>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        >
                                            <div
                                                className={`w-8 h-8 rounded-lg flex items-center justify-center ${isDraft ? "bg-zinc-800 text-zinc-500" : "bg-[#00D09C]/20 text-[#00D09C]"}`}
                                            >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                {["Modern Sans", "Elegant Serif", "Tech Mono", "Soft Rounded"].map(
                                    (font) => (
                                        <div
                                            key={font}
                                            className="p-3 rounded-xl bg-card border border-border hover:bg-secondary/10 cursor-pointer flex items-center justify-between group transition-all"
                                        >
                            ...
                            <div className="flex gap-2">
                                {["Sharp", "Round", "Pill"].map((style) => (
                                    <Button
                                        key={style}
                                        variant="outline"
                                        className="flex-1 bg-card border-border text-muted-foreground text-xs hover:text-foreground hover:bg-secondary/10"
                                    >
                                        {style}
                                    </Button>
                                ))}
