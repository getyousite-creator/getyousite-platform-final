...
export function PreviewCanvas({ blueprint, isGenerating }: PreviewCanvasProps) {
    return (
        <div className="w-full max-w-5xl h-full flex flex-col items-center justify-center space-y-6">
            ...
            <div className="w-full h-[80vh] bg-zinc-950 rounded-[2.5rem] shadow-[0_0_100px_rgba(0,0,0,0.8)] overflow-hidden border border-white/5 relative group">
                {/* Visual Polish: Glass Shine */}
                <div className="absolute inset-0 bg-gradient-to-tr from-white/5 via-transparent to-transparent pointer-events-none opacity-50" />
