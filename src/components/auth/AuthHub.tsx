                ...
                {mode === "check-email" ? (
                    <div className="space-y-6 text-center py-10">
                        ...
                        <Button
                            ...
                            variant="glow"
                            className="w-full h-14 bg-white text-black font-black uppercase tracking-widest text-[11px] rounded-2xl"
                        >
                            {t('back_to_login')}
                        </Button>
                    </div>
                    ...
                    <div className="space-y-4">
                            ...
                            {mode !== "reset-password" && (
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className={cn(
                                            "bg-white/[0.03] border-white/5 h-12 text-sm focus:bg-white/[0.07] transition-all rounded-xl",
                        ...
                        <div className="pt-8 text-center flex flex-col items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-[12px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all py-4 px-8 rounded-full border border-white/5 hover:border-white/20 hover:bg-white/5"
                            >
