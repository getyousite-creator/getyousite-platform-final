        ...
        return fallback || (
            <div className="p-10 rounded-[32px] bg-card/5 border border-border flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div className="space-y-1">
                    <h3 className="text-sm font-black uppercase tracking-widest text-foreground">Premium Mandate Required</h3>
                    <p className="text-[10px] text-muted-foreground max-w-[240px]">This feature is gated behind the Pro subscription protocol.</p>
                </div>
                <Link href="/pricing">
