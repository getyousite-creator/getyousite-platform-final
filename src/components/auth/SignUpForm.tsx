        ...
        try {
            ...
            if (error) {
                ...
                if (authData.user) {
                    ...
                    trackExperimentEvent({
                        experimentKey: "exp_playground_cta_v1",
                        eventName: "funnel_signup_success",
                        variant: searchParams.get("variant") || "unknown",
                        intent: searchParams.get("intent") || "",
                        templateId: searchParams.get("template") || "",
                        metadata: { method: "email" },
            ...
            trackExperimentEvent({
                ...
                intent: searchParams.get("intent") || "",
                templateId: searchParams.get("template") || "",
                metadata: { method: "email_exception" },
            });
        } finally {
            setLoading(false);
        }
    ...
    const handleGoogleSignUp = async () => {
        ...
        try {
            ...
            if (error) {
                ...
                trackExperimentEvent({
                    experimentKey: "exp_playground_cta_v1",
                    eventName: "funnel_signup_oauth_start",
                    variant: searchParams.get("variant") || "unknown",
                    intent: searchParams.get("intent") || "",
                    templateId: searchParams.get("template") || "",
                    metadata: { method: "google" },
            ...
            trackExperimentEvent({
                ...
                intent: searchParams.get("intent") || "",
                templateId: searchParams.get("template") || "",
                metadata: { method: "google_exception" },
            });
            setLoading(false);
        }
    };
