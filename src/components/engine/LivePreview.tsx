...
const DynamicRenderer = ({ blueprint }: any) => {
    ...
    return (
        <div style={{ '--primary-color': primaryColor } as any} className="min-h-full">
            {/* 1. Header Rendering */}
            <section id="preview-header" className="border-b border-black/5 p-4 flex justify-between items-center bg-white/80 backdrop-blur-md sticky top-0 z-10">
                <div className="font-black text-xl tracking-tighter" style={{ color: primaryColor }}>{blueprint.name || "Sovereign_Site"}</div>
            ...
            <footer className="p-12 bg-zinc-50 border-t border-black/5 text-center">
                <p className="text-[10px] text-zinc-400 uppercase tracking-widest font-bold">Generated by GYS Sovereign Engine v1.0</p>
            </footer>
        </div>
    );
};
