/**
 * Strategic Synthesis Insights - Smart Statistics Cards
 *
 * Not just numbers - intelligent interpretations powered by Sovereign Logic
...
export const StrategicInsightCard: React.FC<InsightCardProps> = ({
    title,
    value,
    change,
    chartData,
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                {change && (
                    <div
                        className={`flex items-center gap-1 text-sm ${change.direction === "up"
                                ? "text-success"
...
/**
 * Generate synthesis insights from metrics data
 * This calls our sovereign synthesis logic
 */
export async function generateSynthesisInsights(metrics: {
    traffic: number;
    conversions: number;
    bounceRate: number;
    avgSessionDuration: number;
}): Promise<SynthesisInsight[]> {
    // In production, this calls a Synthesis Provider
