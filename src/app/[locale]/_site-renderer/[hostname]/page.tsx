...
export default async function SiteRendererPage({ params }: SiteRendererProps) {
    ...
    if (error || !storeData) {
        console.error(`[RENDERER_ERROR] Store not found or inactive for: ${hostname}`, error?.message);
        return (
            <div className="flex h-screen items-center justify-center bg-[#0A2540] text-white">
                <div className="text-center space-y-6 max-w-md px-8">
                    ...
                    <h1 className="text-xl font-black uppercase tracking-widest text-white/90 font-mono">Identity Not Found</h1>
                    <p className="text-[10px] text-zinc-500 uppercase tracking-[0.2em] leading-relaxed">
                        This digital asset is not yet established on the Sovereign Grid or is currently undergoing neural reconstruction.
                    </p>
                    <div className="pt-8">
                        <a href="https://getyousite.com" className="text-[10px] font-black uppercase tracking-widest text-[#00D09C] hover:underline">
